...
class Home extends Component {
  ...
  componentWillMount() {
    axios
      .get("http://localhost:5000/api/property/count/Mohali")
      .then((response) => {
        this.setState(
          {
            city: {
              ...this.state.city,
              Mohali: response.data,
            },
          },
          () => {
      ...
      .catch((error) => {});
    axios
      .get("http://localhost:5000/api/property/count/Sirhind")
      .then((response) => {
        this.setState(
          {
            city: {
              ...this.state.city,
              Sirhind: response.data,
            },
          },
          () => {
            console.log(this.state);
              ...
              <div className="row mt-5 ">
                <div className="col-12 col-md p-5 text-center">
                  <h1 className="home-title">
                    Now It is Easy to Find Your Dream House
                  </h1>
                  <h2 className="home-subtitle">
                    With LandMiles - No Far From Home
                  </h2>
                  <Link to="/list" className="btn btn-green btn-md mt-3">
                    Check Out
                  </Link>
                </div>
              </div>
